...
const articlesData = [
    {
        id: 12,
        title: "Budget Flights from the Middle East: 8 Underrated Destinations Worth Booking",
        category: "travel",
        categoryDisplay: "Travel & Accommodation",
        excerpt: "Tired of the same vacation spots? These underrated destinations are just a short flight from Kuwait and the Gulf — and they won't drain your savings.",
        image: "images/1-1.png",
        date: "2026-02-20",
        author: "Travel Insider",
        readTime: "7 min read",
        slug: "budget-flights-middle-east-hidden-destinations",
        content: "I used to think flying out of Kuwait meant choosing between Dubai, Istanbul, or London. Then I started digging into lesser-known routes from the Gulf region — and found a whole world of affordable, underrated destinations just a few hours away."
    },
    {
        id: 11,
